...
The second part is the Admin part where the administrator logs in with his password and then he can see the orders. Also the administrator can add, delete or update a category of products or products. Administrator can also see some statistics about the clients. I use session authentication.
