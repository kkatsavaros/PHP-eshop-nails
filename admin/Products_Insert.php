...
<?php
//********************************************************************************************
//							Πατήθηκε το κουμπί εμφάνιση Yποκατηγορίας.
//********************************************************************************************
...
// *************************************************************************************************************************************************
//********************************************************************************************
//							/Αν έχει πατηθεί το κουμπί "Εισαγωγή".
//********************************************************************************************
	...
	<div id="columnRight">
		...
		<form action = "<?php $_SERVER['PHP_SELF']; ?>" method ="post"><!-- -------------------------------------------------------------------------------- -->
			...
			<td bgcolor="F0E1FA"><?php  // ------------------------  Πρώτο ComboBox : Κατηγορία ---------------------------------------
				...
				<input name="show" type="submit" value="Εμφάνιση Υποκατηγορίας" />
			</td>
			<?php
			if (isset($result11) ) {
			...
			<td bgcolor="EDFA73"><?php  // ------------------------  Δεύτερο ComboBox Υποκατηγορία ---------------------------------------
				...
				while ($row = $result->fetch_assoc()) {
					...
					$w3_subcatid=$row['subcatid']; // Πάει στο hidden της δεύτερης φόρμας.
				}
			...
			*/	
			...
			<input type="hidden"  name="abc2" value="<?php echo $w3_subcatid; ?>"/>
			<input type="submit"  name="upload"           value="Εισαγωγή">			
			<input type="reset"   value="Καθαρισμός Φόρμας"></td>
			</tr>
